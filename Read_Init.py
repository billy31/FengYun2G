#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 18-11-1 上午10:33
# @Author  : Zhengyang Lin
# @Site    : 
# @File    : Read_Init.py
# @Software: PyCharm

# 1235 * 169 = 1:07:41.888905 = 1 * 3600 + 7 * 60 + 41.9 = 4061.9
# 4061.9 / (1235 * 169) = 0.019s/pics
...
def init_data(indir, outdir):
    return 0


if __name__ == '__main__':
    begin_time = datetime.datetime.now()
    SUB = 13 # subset into 13x13
    # _in_dir = '/home/lzy/figs/' #'/home2/FY2GTIFF                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                /'
    _in_dir = '/media/lzy/TOSHIBA WU FY2G_MERSI_Landsat/FY2G/NONGLT/'
    _out_dir = '/media/lzy/TOSHIBA WU FY2G_MERSI_Landsat/FY2G_Testing/' #'/home6/FY2G/pis/'
    _geo_dir = '/home/lzy/figs/NOM_ITG_2288_2288(0E0N)_LE.dat'
    os.chdir(_in_dir)
    list_of_aims = sorted(glob.glob("FY2G*2016010*.tif"))
    ...
    for i, files in enumerate(list_of_aims):
        full_disk = np.zeros((BDS, WID, LEN))
